...
ADMIN = int(os.environ.get("ADMIN", 5740743977))
...
async def vip1(bot,update):
	...
	inlimit  = 5740743977
	uploadlimit(int(user_id),5740743977)
	usertype(int(user_id),"VIP1")
	addpre(int(user_id))
	await update.message.edit("Added successfully To Premium Upload limit 10 GB")
	await bot.send_message(user_id,"Thanks for subscribing to our premium plan, hit /activeplan")
